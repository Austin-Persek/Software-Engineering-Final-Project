...
WESTBOUND_TIME_MULTIPLIER: float = 0.045
# TIME TO CRUSIING & DISTIANCE TO CRUSING

TIME_TO_STOP: float = 2.00
RATE_OF_ASCEND_IN_MIN_AT_280KT: float = 280 / 60  # NM per min

# FLIGHT_TYPES
FLIGHT_CRUISING_INTERNATIONAL_IN_FT = 38_000
FLIGHT_CRUISING_1500_MILES_IN_FT = 35_000
FLIGHT_CRUISING_LESS_THAN_1500_MILES_IN_FT = 30_000
FLIGHT_CRUISING_LESS_THAN_350_MILES_IN_FT = 25_000
FLIGHT_CRUISING_LESS_THAN_200_MILES_IN_FT = 20_000

# AIRCRAFT MONTHLY LEASE COSTS (USD)
AIRCRAFT_MONTHLY_LEASE_COSTS = {
    "Boeing 737-600": 245_000,
    "Boeing 737-800": 270_000,
    "Airbus A220-100": 192_000,
...
US_TAKEOFF_LANDING_FEE_USD = 2_000
FR_TAKEOFF_LANDING_FEE_USD = 2_450  # CHANGE ME TO PER MONTH

FUEL_COST_USD = 6.19
FUEL_COST_FR_TO_USD = 1.97 * 1.16
